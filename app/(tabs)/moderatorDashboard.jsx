...
export default function ModeratorDashboard() {
  ...
  const [moderatorDepartment, setModeratorDepartment] = useState(
    DEFAULT_MODERATOR_DEPARTMENT
  );
  ...
  const categoryFilters = useMemo(() => {
    const mappedCategories = getCategoriesForDepartment(moderatorDepartment);
  ...
  }, [moderatorDepartment, assignedComplaintsData]);
  ...
  const loadModeratorDepartment = useCallback(async () => {
    try {
      ...
      if (userError || !user?.email) {
        ...
        setModeratorDepartment(DEFAULT_MODERATOR_DEPARTMENT);
        return DEFAULT_MODERATOR_DEPARTMENT;
      }
      ...
      setModeratorDepartment(finalDepartment);
      ...
      <View style={styles.mainContainer}>
        <View style={styles.fixedHeader}>
          ...
          <TouchableOpacity
            ...
            onPress={() => smoothNavigate("/moderatorProfile")}
          >
        ...
        >
          <View style={styles.greetingContainer}>
            ...
            <Text style={styles.greetingLarge}>Moderator!</Text>
            <Text style={styles.officeText}>{moderatorDepartment || "No department assigned"}</Text>
          </View>
          ...
          <View style={styles.sectionRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() => smoothNavigate("/moderatorAssignedComplaints")}
            >
