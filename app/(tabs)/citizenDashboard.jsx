        ...
        <View style={styles.fixedHeader}>
          ...
          <View style={styles.headerRightActions}>
            <TouchableOpacity
              ...
              onPress={() =>
                smoothNavigate("/(tabs)/citizenNotification")
              }
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => smoothNavigate("/(tabs)/citizenProfile")}
            >
              {profilePhotoUrl ? (
                <Image
        ...
        >
          ...
          <View style={styles.sectionRow}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.75}
              onPress={() => smoothNavigate("/(tabs)/citizenComplaints")}
            >
        ...
        <View style={styles.bottomNav}>
          {bottomTabs.map((tab) => {
            const isActive =
              ...
              (tab.label === "Home" &&
                (pathname === "/" || pathname?.includes("citizenDashboard")));
