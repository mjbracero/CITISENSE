...
import useAdminUnreadNotifications from "./useAdminUnreadNotifications";
      ...
      <View style={styles.mainContainer}>
        <View style={styles.fixedHeader}>
          ...
          <TouchableOpacity
            ...
            onPress={() => smoothNavigate("/adminProfile")}
          >
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={() => smoothNavigate("/adminManageUsers")}
          >
          ...
          <View style={styles.categoriesCard}>
            ...
            <ViewFullReportButton onPress={() => smoothNavigate("/adminAnalytics")} />
          </View>
